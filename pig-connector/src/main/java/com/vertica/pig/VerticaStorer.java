...
public class VerticaStorer extends StoreFunc implements StoreMetadata {
	...
	public VerticaStorer(String hostnames, String db, String port, String username,
						 String password, String isDirect, String maxRejects) {
		this.hostnames = hostnames.split(",");
		this.database = db;
		this.port = port;
		this.username = username;
		this.password = password;
		this.isDirect = Boolean.valueOf(isDirect);
		this.maxRejects = Integer.valueOf(maxRejects);
	}
	...
	public void setStoreLocation(String location, Job job) 
		...
		VerticaConfiguration.configureVertica(conf, hostnames, database, port, username, password, isDirect, maxRejects);
		if (tableDef != null) {
