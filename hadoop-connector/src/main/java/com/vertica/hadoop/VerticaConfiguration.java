...
public class VerticaConfiguration {
    ...
    public static final String IS_DIRECT_OPTION = "mapred.vertica.isdirect";

    public static final String MAX_REJECTS = "mapred.vertica.maxrejects";
    ...
    public static void configureVertica(Configuration conf, String[] hostnames,
                                        String database, String port, String username, String password,
                                        boolean isDirect, int maxRejects) {
        conf.setBoolean(MAP_SPECULATIVE_EXEC, false);
        conf.setBoolean(REDUCE_SPECULATIVE_EXEC, false);
        ...
        conf.set(PASSWORD_PROP, password);
        conf.set(PORT_PROP, port);
        conf.setBoolean(IS_DIRECT_OPTION, isDirect);
        conf.setInt(MAX_REJECTS, maxRejects);
    }
    ...
    public int getMaxRejects() {
        return conf.getInt(MAX_REJECTS, 0);
    }

    public boolean isDirect() {
        return conf.getBoolean(IS_DIRECT_OPTION, true);
    }
